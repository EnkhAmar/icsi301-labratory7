        ...
        <div className="auth_page">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <div className="pass">
                        <input autoComplete="current-password" type={typePass ? "text" : "password"} className="form-control" id="exampleInputPassword1" onChange={handleChangeInput} value={password} name="password" />
