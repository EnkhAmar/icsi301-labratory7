        ...
        <div className="auth_page">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input autoComplete="username" type="text" className="form-control" id="username" 
                ...
                <div className="form-group">
                    ...
                    <input autoComplete="username" type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" 
                ...
                <div className="form-group">
                    ...
                    <div className="pass">
                        <input autoComplete="current-password" type={typePass ? "text" : "password"} className="form-control" id="exampleInputPassword1" 
                ...
                <div className="form-group">
                    ...
                    <div className="pass">
                        <input autoComplete="current-password" type={typeCfPass ? "text" : "password"} className="form-control" id="cf_password" 
